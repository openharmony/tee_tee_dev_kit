...
enum __TEE_DK_ObjectAttribute {
    /** A pointer to shared secret value. */
    TEE_DK_SECRECT = 0,
    /** A pointer to structure containing other data. */
    TEE_DK_OTHER,
    /** The enumerator ID of the HASH function to be used. */
    TEE_DK_HASH_MODE,
    /** The enumerator ID of the derivation function mode. */
    TEE_DK_DERIVATION
};
